; ModuleID = 'seeds/seed_57899/nl:InstCombineCasts.cpp:transformZExtICmp:11.ll'
source_filename = "seeds/seed_57899/nl:InstCombineCasts.cpp:transformZExtICmp:11.ll"
...
entry:
  %call134 = call i64 @duplicate_node()
  ret i32 0
}

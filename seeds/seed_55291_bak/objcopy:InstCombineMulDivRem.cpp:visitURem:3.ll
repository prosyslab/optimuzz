...
define i64 @_bfd_dwarf2_find_symbol_bias() {
for.body9:
  %call10 = call i1 @comp_unit_maybe_decode_line_info()
  ret i64 0
}
...
declare i1 @read_formatted_entries()

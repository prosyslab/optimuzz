...
if.then49:
  call void @anonymize_ident_line(ptr undef, i32 undef, i64 undef)
  ret void
}

declare void @strbuf_setlen.3207()

define internal void @anonymize_ident_line(ptr %anonymize_ident_line.which_buffer, i32 %0, i64 %conv) {
entry:
  %1 = load i32, ptr %anonymize_ident_line.which_buffer, align 4
  %conv1 = zext i32 %0 to i64
  %rem = urem i64 %conv, 2
  %conv12 = trunc i64 %rem to i32
  store i32 %conv12, ptr %anonymize_ident_line.which_buffer, align 4
  ret void
}

...
if.end353:                                        ; preds = %if.else349
  br label %do.end355

do.end355:                                        ; preds = %if.end353
  %0 = load i32, ptr %augmentation_string_size, align 4
  %rem = urem i32 %0, 4
...
declare i1 @load_debug_section_with_follow()

; uselistorder directives
uselistorder ptr undef, { 0, 14, 15, 7, 2, 3, 11, 16, 5, 6, 4, 1, 17, 12, 18, 13, 19, 8, 9, 10 }

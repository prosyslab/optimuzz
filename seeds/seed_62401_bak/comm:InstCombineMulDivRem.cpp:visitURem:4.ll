...
define internal i64 @quotearg_buffer_restyled(ptr %quote_these_too.addr, i64 %conv571) {
entry:
...
land.lhs.true575:                                 ; preds = %entry
  %0 = load i8, ptr %quote_these_too.addr, align 1
  br label %if.end578
...
entry:
  %call211 = call i64 @quotearg_buffer_restyled(ptr null, i64 0)
  ret ptr null
}

define ptr @quotearg_n_style_mem() {
entry:

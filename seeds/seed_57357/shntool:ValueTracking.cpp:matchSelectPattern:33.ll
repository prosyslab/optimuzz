...
entry:
  %call741 = call i32 @cmp_files(ptr null)
  ret i32 0
}

define internal i32 @cmp_files(ptr %real_shift) {
entry:
  ...
  %cond15 = select i1 %cmp11, i32 %sub, i32 %2
  store i32 %cond15, ptr %real_shift, align 4
  ret i32 0
}
